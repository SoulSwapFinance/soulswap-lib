...
describe('PairNamer', () => {
  ...
  describe('#pairName', () => {
    ...
    it('concatenation', async () => {
      expect(await pairName('DAI Stable Coin', 'MKR Token', 'SoulSwap Liquidity Provider Share for ', '.')).to.eq(
        'SoulSwap Liquidity Provider Share for DAI Stable Coin:MKR Token.'
      )
    })
  })
